...
export class BlueskyV2 implements INodeType {
	...
	constructor(baseDescription: INodeTypeBaseDescription) {
		this.description = {
			...
			properties: [resourcesProperty, ...userProperties, ...postProperties, ...feedProperties, ...searchProperties, ...graphProperties, ...analyticsProperties, ...listProperties], // ...chatProperties temporarily disabled, notificationProperties removed as redundant
		};
	}
